...
export const ExperienceSection = ({ isBooting }: { isBooting: boolean }) => {
  ...
  return (
    <section id="experience" className="py-16 md:py-32 px-6 bg-gray-50">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8 md:mb-16">
          <div className="flex items-center gap-4">
            <h2 className="text-3xl md:text-6xl font-sketch">The Logbook</h2>
          ...
          <div className="flex items-center gap-2 px-3 py-1 sketch-border bg-yellow-50 rotate-2">
            ...
            <span className="font-sketch text-sm hidden sm:inline">
              Powered by GSAP
            </span>
          </div>
        </div>
        ...
        <div className="space-y-12 md:space-y-24 relative">
          ...
          {EXPERIENCE.map((exp, index) => (
            <div
              key={exp.company}
              className="relative pl-12 md:pl-0 experience-item pb-12 md:pb-32 last:pb-0"
            >
              {/* Timeline Dot */}
              ...
              <div className="grid md:grid-cols-12 gap-4 md:gap-8 relative">
                <div className="md:col-span-3">
                  <div className="md:sticky md:top-32 md:pl-8 experience-period">
                    {/* Mobile: compact badge */}
                    <span className="md:hidden font-mono text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded">
                      {exp.period}
                    </span>

                    {/* Desktop: date-stamp layout */}
                    {(() => {
                      ...
                      return (
                        <div className="hidden md:block">
                          <p className="font-mono text-[10px] uppercase tracking-widest text-gray-400 mb-1">From</p>
                          <p className="font-sketch text-5xl text-gray-800 leading-none">{startYear}</p>
                          <p className="font-sketch text-sm text-gray-400 mt-1">{startMonth}</p>

                          {endYear && (
                            <>
                              <div className="my-3 w-px h-6 bg-black/10 border-l border-dashed border-black/20 ml-2" />
                              <p className="font-mono text-[10px] uppercase tracking-widest text-gray-400 mb-1">To</p>
                              <p className="font-sketch text-5xl text-gray-800 leading-none">{endYear}</p>
                              <p className="font-sketch text-sm text-gray-400 mt-1">{endMonth}</p>
                            </>
                          )}

                          <div className="h-1.5 w-16 bg-yellow-400/40 mt-4 rounded-full" />
                        </div>
                      );
                    })()}
                  </div>
                ...
                <div className="md:col-span-9 relative">
                  ...
                  <motion.div
                    ...
                    className={`sketch-border p-4 md:p-8 bg-white shadow-sm hover:shadow-2xl transition-all duration-500 experience-card relative overflow-hidden group ${index % 2 === 0 ? "rotate-1" : "-rotate-1"}`}
                  >
                    ...
                    <div className="relative z-10">
                      <h3 className="text-2xl md:text-4xl font-sketch mb-1 experience-content-stagger">
                        {exp.role}
                      </h3>
                      <p className="text-lg md:text-2xl font-sketch text-blue-600 mb-4 md:mb-6 experience-content-stagger flex items-center gap-2">
                        <span className="text-gray-400">@</span> {exp.company}
                      </p>

                      <p className="text-base md:text-xl font-sketch text-gray-800 mb-6 md:mb-8 leading-relaxed experience-content-stagger max-w-2xl">
                        {exp.description}
                      </p>

                      <div className="flex flex-wrap gap-3 mb-6 md:mb-8 experience-content-stagger">
                        {exp.tech?.map((t) => (
                          <span
                            key={t}
                      ...
                      <div className="space-y-4 experience-content-stagger">
                        ...
                        <ul className="space-y-4">
                          {exp.achievements.map((ach) => (
                            <li
                              key={ach}
                              className="flex items-start gap-4 font-sketch text-base md:text-lg text-gray-700 group/item"
                            >
