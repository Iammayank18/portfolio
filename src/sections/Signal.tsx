  ...
  return (
    <section id="signal" className="relative px-5 sm:px-8 pt-24 sm:pt-32 pb-16">
      <div className="mx-auto w-full max-w-[1400px]">
        {/* marquee */}
        <div className="overflow-hidden border-y py-4 mb-16" style={{ borderColor: "var(--line)" }}>
          <div className="marquee-track">
            {[0, 1].map((k) => (
              <span key={k} className="font-display text-2xl sm:text-3xl font-bold whitespace-nowrap pr-6">
                {MARQUEE.repeat(2)}
              </span>
            ))}
          </div>
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-end">
          ...
          >
            ...
            <p className="mt-5 max-w-md text-[15px] leading-relaxed" style={{ color: "var(--ash)" }}>
              Building something that needs to survive real traffic? I'm available for
              frontend and full-stack work. Send a signal and I'll respond.
            </p>
            ...
            <div className="panel ticked p-6 flex flex-col gap-1">
              {[
                ...
                >
                  ...
                  <span className="font-mono text-[13px] link-underline">{val}</span>
                </a>
              ))}
              <div className="flex items-center justify-between pt-4 mt-2 border-t" style={{ borderColor: "var(--line)" }}>
                <span className="hud-label" style={{ color: "var(--ash)" }}>STATUS</span>
                <span className="inline-flex items-center gap-1.5 hud-label" style={{ color: "var(--forest)" }}>
